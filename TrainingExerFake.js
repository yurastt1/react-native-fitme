...
export const TrainingExerFake =( { navigation } )=> {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Plank</Text>
      <Text style={styles.subTitle}>Jump with enough force to propel both feet off the floor.</Text>
    <View style={styles.buttonSep}>
        <TouchableOpacity
          onPress={()=>navigation.navigate('TrainingExerFake1')}
